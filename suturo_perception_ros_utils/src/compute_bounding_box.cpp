...
class BoundingBoxIO : public BasicIOPCD
{
  public:
    BoundingBoxIO(int argc, char** argv) : BasicIOPCD(argc, argv)
    {
    }
    void execute()
    {
    ...
    // your point cloud
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr point_cloud_ptr = input_cloud_;
