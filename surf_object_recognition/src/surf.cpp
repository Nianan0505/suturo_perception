 ...
 */
bool surf_recognition(std::string train_image, std::string test_image, bool headless){
...
int main( int argc, char** argv )
{
  ...
  // Run all test images against SURF
  for(int i=0;i<test_images.size();i++)
  {
    surf_recognition(train_image,test_images.at(i),headless_mode);
    cout << endl;
  }
  return 0;
  }
