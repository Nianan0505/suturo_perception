...
LabelAnnotator2D::LabelAnnotator2D(boost::shared_ptr<cv::Mat> original_image, ObjectMatcher &object_matcher)
  : original_image_(original_image), object_matcher_(object_matcher)
{
